...
namespace Middleware1
{
    ...
    public partial class Middleware1 : Form
    {
        ...
        int recNum = 0;//Receive Counter
        int seqNum = 0;//sequencer number
            ...
            try
            {
                ...
                while (true)
                {
                    ...
                    while (true)
                    {
                        ...
                        else if (data.IndexOf("<ASK>") > -1)
                        {
                            seqNum += 1;
                            sendSequence(data.Substring(0,data.Length-5));
                            break;
                        }
        ...
        public void sendMessage()
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    string full_message = "Msg #" + mescount.ToString() + " from Middleware 1 : " + timestamp + " <EOM>\n";
                    //string msg_flag = "MW1" + mescount.ToString();
                    // Generate and encode the multicast message into a byte array.
                    byte[] msg = Encoding.ASCII.GetBytes(full_message);
        ...
        public void sendSequence(string message)
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    byte[] msg = Encoding.ASCII.GetBytes(message + "," + seqNum + "<seqNum>");
                    int bytesSent = sendSocket.Send(msg);
